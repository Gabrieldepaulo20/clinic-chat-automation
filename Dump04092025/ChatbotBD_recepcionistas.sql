...
CREATE TABLE `recepcionistas` (
  ...
  CONSTRAINT `recepcionistas_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-09-04  0:59:03
