...
CREATE TABLE `profissionais` (
  ...
  `cro` varchar(15) DEFAULT NULL,
  `data_criacao` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `data_atualizacao` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_profissional`),
  UNIQUE KEY `cro` (`cro`),
  KEY `id_usuario` (`id_usuario`),
  CONSTRAINT `profissionais_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `profissionais` VALUES (1,71,'clinico_geral','123456','2025-05-28 23:11:44','2025-05-28 23:11:44');
...
-- Dump completed on 2025-09-04  0:59:54
